  ...
  render() {
    ...
    return ( // TODO ask if there an easy way to keep the tool group as "redact"
      ...
      >
        ...
        {showApply &&
        <Button className="ToolButton" dataElement="applyAllButton" title="action.applyAll" img="ic_check_black_24px"
                onClick={this.handleApplyButtonClick}
        />}

        <div className="spacer hide-in-desktop"></div>
        <Button className="close hide-in-desktop" dataElement="toolsOverlayCloseButton" img="ic_check_black_24px"
